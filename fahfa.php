	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-9">
				...
				<a href="index.php" type="button" name="keluar" class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin keluar ?');">Keluar</a>
			</div>
			<div class="row">
				<div class="col-2">
				</div>
				<div class="col-9">
					...
					<br>
					<button type="button" class="btn btn-success">Isi Catatan Perjalanan</button>
				</div>
			</div>
			<!-- Boostrap JS Start -->
